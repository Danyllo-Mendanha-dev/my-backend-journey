...
const my3FavoriteTVShows = ['O Senhor dos Anéis', 'Irmãos Urso', 'O rei leão']
...
const randowTVShow = 'Watchmen'
const isRandomTVShowsIncluded = my3FavoriteTVShows.includes(randowTVShow)
// console.log(isRandomTVShowsIncluded)
...
const typeSentence = `O tipo de dado que a const "isRandomTVShowIncluded" armazena é: ${typeof isRandomTVShowsIncluded}`
...
const isNotAsString = typeof randowTVShow !== 'string'
console.log(isNotAsString)
